...
const IPWiresTutorial = {
    ...
    showPacketsShifted(onComplete) {
        const dm = IP2Live.DialogueManager;
        if (dm && typeof dm.startById === 'function' && dm.getDialogue && dm.getDialogue('stage1.ipwires.tutorial.shifted')) {
            return dm.startById('stage1.ipwires.tutorial.shifted', {
                source: 'IPWiresTutorial.showPacketsShifted',
                timing: 'after',
                mapId: 3,
                gameplayId: 'ip_class_wires',
    ...
    showStageRepairReset(failedLabel, onComplete) {
        ...
        const dm = IP2Live.DialogueManager;
        if (dm && typeof dm.startById === 'function' && dm.getDialogue && dm.getDialogue('stage1.ipwires.recovery.reset')) {
            return dm.startById('stage1.ipwires.recovery.reset', {
                source: 'IPWiresTutorial.showStageRepairReset',
                timing: 'after',
                mapId: 3,
                gameplayId: 'ip_class_wires',
                trigger: 'gameplay.failed',
