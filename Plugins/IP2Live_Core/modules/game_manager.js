    ...
    gameplayCatalog: {
        ip_class_wires: {
            ...
            quests: [
                ...
                { id: 'stage.5.mixed.05.ip_wires', gameplayId: 'ip_class_wires', objectiveId: 'repair_stage5_ip_wires_05', title: 'REPAIR IP WIRES 05', label: 'Wire Relay 05', mapId: 5, sequence: 5, targetTile: { x: 22, y: 0, z: 15 } },
